...
function Home() {
    ...
    return (
        <div className="bg-gray-50 text-gray-900">
            ...
            {/* Main Content */}
            <main className="pt-16"> {/* Add pt-16 to avoid content overlapping with fixed navbar */}
                {/* Section 1 */}
                <section id="home" className="text-center py-20">
                    ...
                    <div className="mt-8 flex justify-center space-x-4">
                        <Link to="about" smooth={true} duration={500}>
                            <button className="px-8 py-3 bg-gray-900 text-white font-semibold rounded-full hover:bg-gray-700">Get Started</button>
                        </Link>
