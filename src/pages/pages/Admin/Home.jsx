        ...
        <div className="bg-gray-100 flex items-start justify-center p-3 rounded-xl">
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                    ...
                    />
                    <h1 className="text-3xl font-bold text-gray-900 mb-2 text-center">{userInfo?.fullName || 'User'}</h1>
                    <p className="text-gray-600 mb-4 text-center">
                        I am a passionate web developer with expertise in creating dynamic and responsive websites using
                        modern technologies. My goal is to build intuitive and engaging user experiences.
                    </p>
                    ...
                    <div className="flex justify-center space-x-2 mb-4">
                        ...
                        <span
                            className="bg-purple-100 text-purple-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">React.js</span>
                    </div>
                    ...
                    <div className="border-t pt-4 mt-4">
                        ...
                        <ul className="list-disc list-inside text-gray-600 space-y-2">
                            <li><strong>Project A:</strong> A responsive e-commerce website built with React and Redux.
                            </li>
                            <li><strong>Project B:</strong> A mobile-friendly blogging platform using Vue.js and
                                Firebase.
                            </li>
                        </ul>
                    </div>
